...
export default function RestTimerBar({ remainingSeconds, setNumber, isPaused, onOpen }: RestTimerBarProps) {
  return (
    <button
      ...
      className="flex min-h-14 w-full items-center gap-2 rounded-lg bg-primary/10 px-3 py-2 text-left focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary"
    >
      ...
      <span role="timer" aria-live="off" aria-label={`${remainingSeconds} Sekunden verbleibend`} className="text-xl font-semibold tabular-nums">
